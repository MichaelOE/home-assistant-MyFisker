...
from homeassistant.const import CONF_ALIAS, CONF_HOST, CONF_PASSWORD, CONF_USERNAME
...
async def validate_login(hass: HomeAssistant, data: dict[str, Any]) -> dict[str, Any]:
    ...
    api = MyFiskerAPI(data[CONF_USERNAME], data[CONF_PASSWORD])
    ...
    return vin  # {"title": f"My Fisker Ocean ({vin})"}
